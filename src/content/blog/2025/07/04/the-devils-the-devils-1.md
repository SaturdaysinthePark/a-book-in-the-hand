...
The setting is placed in an alternative version of our world during a medieval time where the plague is rampant and the church in power, which felt like I was in a similar setting to *Between Two Fires*.

I've always meant to read Joe Abercrombie, and felt this would be a good introduction since it's a standalone book. While it is fun, I felt it was derivative from the plot and setting of many works before it. The strong points of the book kept me hooked especially the unique cast of characters and how they all fit into the wonderful set pieces of combat and infiltration during the journey facing off against other monsters and humans. So if you like these kind of stories and this setting, then you're going to love this one, highly recommended!