...
postType: "list"
status: "live"
tags: ["mystery", "reading slump", "recommendations", "page-turners"]
ranked: false
picks:
  - bookTitle: "The Murder of Roger Ackroyd"
    author: "Agatha Christie"
    cover: "https://m.media-amazon.com/images/S/compressed.photo.goodreads.com/books/1348020113i/9618464.jpg"
    meta: "288 pages · 1926"
    rating: 5
    reviewUrl: "/blog/2016/06/30/the-murder-of-roger-ackroyd/"
    blurb: "One of the best examples of a 'close circle' mysteries ever written. Set in a quiet English village, you have the clues, the suspects, and the chance to solve the case with the detective, Hercule Poirot. You'll go straight into theory mode after the first few pages and likely won't put it down after picking it up. I still think about how this one turned out to this day. This will definitely get you out of a reading slump."
  - bookTitle: "The Hound of the Baskervilles"
    author: "Arthur Conan Doyle"
    cover: "https://covers.openlibrary.org/b/id/8063264-L.jpg"
    meta: "224 pages · 1902"
    rating: 4
    blurb: "Sherlock Holmes always has a way to turn a small detail into the most important clue. This novel has quite an atmosphere, one where to this day I can imagine the fog in the moors where the mystery is set. A supposed family curse, a spectral hound howling across the moor, and a death that looks impossible. It's an incredibly difficult mystery that only Sherlock Holmes can solve."
  - bookTitle: "The Westing Game"
    author: "Ellen Raskin"
    cover: "https://m.media-amazon.com/images/S/compressed.photo.goodreads.com/books/1378877564i/481510.jpg"
    meta: "182 pages · 1978"
    rating: 3
    blurb: "You might look this up and see this listed as children's literature, but it will keep any adult turning the pages. The Westing Game is where sixteen strangers, a dead millionaire, and a will turns into a scavenger hunt with a killer hiding among the heirs. It's short and clever, but built entirely out of clues you can actually solve yourself. The novel is sort of a game you end up playing along the way."
  - bookTitle: "The Girl with the Dragon Tattoo"
    author: "Stieg Larsson"
    cover: "https://m.media-amazon.com/images/S/compressed.photo.goodreads.com/books/1684638853i/2429135.jpg"
    meta: "465 pages · 2005"
    rating: 5
    blurb: "A more modern mystery, where a journalist is hired to investigate a decades long mysterious disappearance. Compared to others in my list here, its a longer novel, but I felt that there are some longer burn mysteries that keep you guessing what happened like this one. Once the tires start moving in the journalist's investigation, paired with a hacker, you'll stay up all night to read this one. The setting is incredible ..."
  - bookTitle: "The Silent Patient"
    author: "Alex Michaelides"
    cover: "https://m.media-amazon.com/images/S/compressed.photo.goodreads.com/books/1668782119i/40097951.jpg"
    meta: "336 pages · 2019"
    rating: 3
...
Most novels ask you to invest quite a bit into them and their characters, world building, even the writing style at times. That investment and perhaps a thick stack of pages to complement it can be quite daunting. Before you get anything in return from the book, you're being asked to learn the history of that book's world and cast of characters. So when you start reading, your brain is already hitting some psychological friction.
...
I'll always recommend Agatha Christie, and of course if you love _The Murder of Roger Ackroyd_ you'll love her other works such as _The Murder on the Orient Express_, _Death on the Nile_ and _And Then There Were None_ by Agatha Christie.

Looking for more? Here's [every mystery novel I've read](/book-reviews?subgenre=Mystery).